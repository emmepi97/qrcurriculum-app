...
export default function HomePage(){
  ...
  return <main className="marketingPage proofHome">
    <header className="marketingNav proofNav">
      ...
      <nav><Link href="/privacy-policy">{t.privacy}</Link><Link href="/cookie-policy">{t.cookie}</Link><LanguageToggle/><Link className="btn primary" href="/login">{t.login}</Link></nav>
    </header>
    ...
    <footer className="marketingFooter proofFooter"><b>QR Curriculum</b><span>Privacy Policy · Cookie Policy</span></footer>
  </main>
}
