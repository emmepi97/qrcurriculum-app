...
export default function AnalyticsPage() {
  ...
  async function load() {
    try {
      ...
      // Tutti gli eventi vengono salvati con profile_user_id = id del
      // proprietario del profilo (impostato lato pubblico al momento della
      // visita), quindi basta filtrare su questo campo: è anche l'unico
      // filtro coerente con la policy RLS di lettura.
      ...
      setError(`${e.message}. Se non vedi dati, verifica di aver eseguito migration_v17_fixes.sql e che il profilo pubblico venga visitato tramite /qrcv/slug.`);
    } finally {
      setLoading(false);
    }
  }
