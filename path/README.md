...
## V16 modifiche applicate
- Anteprima CV spostata a destra su desktop, sotto editor da mobile.
- `Presente/Present` sostituito con `Adesso/Now`.
- Rimosso caricamento automatico massivo di tutte le sezioni in dashboard per velocizzare l'apertura.
- Rimosse dal menu e dal progetto le pagine Directory, CV multipli e Monetization.
- Rimossa la CTA consulenza dalla pagina pubblica del CV.
- Menu mobile forzato ad hamburger fino a 1180px.
- Analytics resi più leggibili e mantenuti con query robusta su user_id/slug.
- Radar Skill reso responsive e modello Index esplicitato con formula a pesi.
- Job Match: textarea non ridimensionabile e rimossa sezione “Come monetizzarla meglio”.
- Home: aggiunto bottone “Richiedi una recensione”.
- Pagina Consultazione ricostruita come landing semplice e pulita.
- CSS aggiornato con override mobile-first e stile più ordinato.
